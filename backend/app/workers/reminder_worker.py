...
class ReminderWorker(RetryableWorker, BaseWorker):
    ...
    def _render_reminder_body(
        ...
        Video reminders always include either the real Meet URL or truthful
    ...
    def _append_video_call_details(message: str, appointment: Appointment) -> str:
        """Append the provider-issued Meet URL once, never a fabricated link."""
        ...
        if appointment.meeting_url:
            if appointment.meeting_url in message:
                return message
            return f"{message}\nJoin Google Meet: {appointment.meeting_url}"
