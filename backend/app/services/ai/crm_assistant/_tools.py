    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "calls and recovery, after-hours coverage. technicians = per-person activity "
                "context. These are activity profiles, not rankings — present them as "
                "context, never as a leaderboard."
            ),
            "parameters": {
                "type": "object",
                "properties": {
