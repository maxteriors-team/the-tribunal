...
from app.services.telephony.inbound_text import InboundTextEvent
...
async def test_media_only_reply_skips_text_interpreters_and_ai(
    ...
    ingest_message = AsyncMock(return_value=message)
    ...
    assert push_service.send_to_workspace_members.await_args.kwargs["body"] == "Photo received"
