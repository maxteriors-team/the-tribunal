"""Fixtures for ad-intelligence service tests.
...
closed`` when integration tests run back-to-back. Disposing the pool around
each test guarantees fresh connections bind to the current loop.
"""
