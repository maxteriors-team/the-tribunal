...
- Existing legacy deposit fields remain separate; they are not the customer’s Permanent card-payment record.
...
- The feature defaults off per workspace; only an explicitly approved operator may expose or charge these choices.
