...
- **Single job:** Turn *"this yard would look great with path lights"* into a sent
  proposal before the technician leaves the driveway.
...
*selection only*, because selection is the one piece of state the technician is
