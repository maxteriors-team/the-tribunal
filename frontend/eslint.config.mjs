...
const eslintConfig = defineConfig([
  ...
  globalIgnores([
    ...
    "test-results/**",
    "next-env.d.ts",
    // Local `netlify build` output: bundled copies of app code that fail to
    // load our plugins and would break `npm run lint` on any machine that has
    // ever run the Netlify CLI here. Absent in CI's fresh clone.
    ".netlify/**",
