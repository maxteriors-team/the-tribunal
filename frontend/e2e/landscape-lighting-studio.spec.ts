...
test.describe("landscape lighting studio", () => {
  ...
  test("captures representative desktop and mobile drawing states", async ({ page }) => {
    ...
    await page.getByLabel("Add accessory to fixture 1").selectOption("ground-stake");
    await page.screenshot({
      path: "../.ezcoder/screenshots/tribunal-fixture-schedule-desktop.png",
      fullPage: true,
      animations: "disabled",
    });
    ...
    await page.getByRole("tab", { name: "BOM" }).click();
    await page.screenshot({
      path: "../.ezcoder/screenshots/tribunal-bom-desktop.png",
      fullPage: true,
      animations: "disabled",
    });
    ...
    await page.getByRole("tab", { name: "Fixture Schedule" }).click();
    await page.getByRole("tab", { name: "BOM" }).click();
    await expect(page.getByRole("tab", { name: "BOM" })).toBeInViewport({ ratio: 1 });
    await page.screenshot({
      path: "../.ezcoder/screenshots/tribunal-bom-mobile.png",
      fullPage: true,
      animations: "disabled",
    });
    await page.getByRole("tab", { name: "Drawing Sheet" }).click();
